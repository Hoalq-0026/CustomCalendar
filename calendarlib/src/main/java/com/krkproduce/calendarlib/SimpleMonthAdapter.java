...
public class SimpleMonthAdapter extends RecyclerView.Adapter<SimpleMonthAdapter.ViewHolder>
    ...
    private static final int MAX_YEARS = 2100;
    ...
    private CalendarDay reservationClosedDay;
    private CalendarDay reservationInquiryDay;
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int position) {
        ...
        monthView.setReservationCloseDay(reservationClosedDay);
        monthView.setReservationInquiryDay(reservationInquiryDay);
    ...
    public void setSelectedDay(CalendarDay calendarDay) {
        if (!typedArray.getBoolean(R.styleable.DayPickerView_enableMultiSelect, false)) {
    ...
    public void setReservationClosedDay(CalendarDay closedDay) {
        if (closedDay != null) {
            this.reservationClosedDay = closedDay;
            notifyDataSetChanged();
        }
    }

    public void setReservationInquiryDay(CalendarDay inquiryDay) {
        if (inquiryDay != null) {
            this.reservationInquiryDay = inquiryDay;
            notifyDataSetChanged();
        }
    }
